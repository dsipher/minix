...
L265:
	...
	movq 16(%rcx),%rcx
	movq %rax,(%rcx,%r13,8)
	movl -24(%rbp),%edx # spill
	movl %ebx,%esi
	movq -40(%rbp),%rdi # spill
	call _assoc
	cmpl %ebx,-16(%rbp) # spill
	jz L328
L326:
	xorl %esi,%esi
	movl $-1275068397,%edi
