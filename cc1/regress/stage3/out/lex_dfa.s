...
L85:
	...
	jmp L87
L88:
	movl _ecgroup(,%r12,4),%edi
	call _abs
	movslq %eax,%rax
	movl (%r13,%rax,4),%eax
	movl %eax,-1024(%rbp,%r12,4)
	incl %r12d
L87:
...
L101:
	...
	movq %rdx,-32(%rbp) # spill
	movq %rcx,-16(%rbp) # spill
	movq %r8,-24(%rbp) # spill
	movl -36(%rbp),%r13d # spill
	cmpl $0,L103(%rip)
	jnz L107
L105:
	movl $4,%esi
...
L114:
	...
	jz L120
L118:
	movl -52(%rbp),%ecx # spill
	incl %ecx
	movl %ecx,-52(%rbp) # spill
	movq -32(%rbp),%rax # spill
	movl %edx,(%rax,%rcx,4)
L120:
	addl %r12d,-48(%rbp) # spill
	incl %r15d
L108:
	cmpl %r15d,-36(%rbp) # spill
	jge L109
L111:
	movl $1,-40(%rbp) # spill
	jmp L121
...
L149:
	movslq %r13d,%rax
	movl %r12d,(%rbx,%rax,4)
	movl -44(%rbp),%ecx # spill
	movl -48(%rbp),%eax # spill
	leal 32000(%rcx,%rax),%eax
	movl %eax,-48(%rbp) # spill
L133:
...
L192:
	...
	incl %edi
	call _allocate_array
	movq %rax,-5200(%rbp) # spill
	movl $4,%esi
	movl _current_max_dfa_size(%rip),%edi
	call _allocate_array
	movq %rax,%rbx
	movl $0,-5184(%rbp) # spill
	movl $0,-5168(%rbp) # spill
	xorl %eax,%eax
	jmp L193
L194:
...
L232:
	...
	movl %eax,-5180(%rbp) # spill
	movl %eax,-5176(%rbp) # spill
	movl -5180(%rbp),%eax # spill
	shll $1,%eax
	movl %eax,-5164(%rbp) # spill
	movl %eax,-5180(%rbp) # spill
	movl $1,%r12d
	jmp L248
L249:
...
L270:
	incl _numas(%rip)
	movl -5176(%rbp),%eax # spill
	leal 1(,%rax,2),%eax
	movl %eax,-5164(%rbp) # spill
	incl -5184(%rbp) # spill
L272:
	movl -5184(%rbp),%eax # spill
	cmpl -5168(%rbp),%eax # spill
	jle L274
L273:
	xorl %r15d,%r15d
	xorl %r14d,%r14d
...
L275:
	...
	jle L276
L278:
	movl -5168(%rbp),%ecx # spill
	incl %ecx
	movl %ecx,-5168(%rbp) # spill
	movl %ecx,-3100(%rbp)
	movq _dss(%rip),%rax
	movq (%rax,%rcx,8),%rax
	movq %rax,-5192(%rbp) # spill
	movq _dfasiz(%rip),%rax
	movl (%rax,%rcx,4),%eax
	movl %eax,-5204(%rbp) # spill
	cmpl $0,_trace(%rip)
	jz L281
L279:
	pushq %rcx
...
L281:
	leaq -1028(%rbp),%rcx
	leaq -2056(%rbp),%rdx
	movl -5204(%rbp),%esi # spill
	movq -5192(%rbp),%rdi # spill
	call _sympartition
	movl $1,%r13d
	jmp L283
L284:
	cmpl $0,-2056(%rbp,%r13,4)
	jz L289
L287:
	movl $0,-2056(%rbp,%r13,4)
	movl -1028(%rbp,%r13,4),%eax
	testl %eax,%eax
	jnz L291
L290:
	movq %rbx,%rcx
...
L291:
	movslq %eax,%rax
	movl -3084(%rbp,%rax,4),%r12d
	movl %r12d,-3084(%rbp,%r13,4)
	cmpl $0,_trace(%rip)
	jz L309
L307:
	pushq %r12
...
L289:
	incl %r13d
L283:
	cmpl %r13d,_numecs(%rip)
	jge L284
L286:
	addl %r14d,_numsnpairs(%rip)
	cmpl $0,_caseins(%rip)
	jz L315
L316:
	cmpl $0,_useecs(%rip)
...
L369:
	...
	movl %ecx,-28(%rbp) # spill
	movl %r8d,-12(%rbp) # spill
	movq %r9,-8(%rbp) # spill
	xorl %ebx,%ebx
	movl $1,%r15d
	jmp L371
...
L498:
	...
	pushq %r15
L499:
	movq %rdi,-1040(%rbp) # spill
	movl %esi,-1044(%rbp) # spill
	movq %rdx,%r15
	movq %rcx,-1056(%rbp) # spill
	movl $1,%esi
	jmp L501
L502:
	movl %esi,%edx
...
L504:
	...
	movl $1,%r14d
L505:
	cmpl %r14d,-1044(%rbp) # spill
	jl L500
L506:
	movq -1040(%rbp),%rax # spill
