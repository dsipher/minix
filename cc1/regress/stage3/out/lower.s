...
L162:
	movq %rdi,%rbx
	movl %esi,-20(%rbp) # spill
	movl %edx,-4(%rbp) # spill
	movl -20(%rbp),%r12d # spill
...
L427:
	...
	xorl %edx,%edx
	subl -60(%rbp),%edx # spill
	movl $40,%ecx
	movl -60(%rbp),%esi # spill
	leaq 752(%r13),%rdi
	call _vector_insert
L428:
	movl $0,-4(%rbp) # spill
...
L450:
	...
	jmp L440
L451:
	movl -104(%rbp),%eax # spill
	cmpl %eax,-76(%rbp) # spill
	jae L454
L453:
	incl %r12d
	jmp L440
...
L850:
	...
	movl %eax,%r12d
	leal (%r14,%r12),%eax
	movl %eax,-120(%rbp) # spill
	cmpl $0,-128(%rbp) # spill
	jz L852
L851:
	cmpl $0,28(%r15)
	movl $-1610602933,%eax
...
L1215:
	movq %rdi,%r15
	movl %esi,%r14d
	movq %rdx,-200(%rbp) # spill
	movq %rcx,-208(%rbp) # spill
	movq %r8,-216(%rbp) # spill
	movl $0,-224(%rbp) # spill
	movq -216(%rbp),%rdi # spill
	call _words
	cmpl $3,%eax
	jle L1217
L1247:
...
L1240:
	...
	movq %rax,-16(%rbp)
	subl %r12d,%ebx
	addl $2,-224(%rbp) # spill
L1235:
	testl %ebx,%ebx
	jnz L1236
L1219:
	movl -224(%rbp),%eax # spill
L1216:
	popq %r15
	popq %r14
	popq %r13
...
L1427:
	...
	pushq %r15
L1428:
	movq %rdi,-216(%rbp) # spill
	movl %esi,%ebx
	movq -216(%rbp),%rax # spill
	movq 16(%rax),%rax
	movslq %ebx,%rbx
	movq (%rax,%rbx,8),%r12
	movl %ebx,-188(%rbp) # spill
	xorl %esi,%esi
	movl $385878080,%edi
	call _new_insn
	movq %rax,%r14
	...
	movl %eax,8(%r14)
	leal 1(%rbx),%eax
	movl %eax,-196(%rbp) # spill
	movl %eax,-200(%rbp) # spill
	movl %ebx,%edx
	movq -216(%rbp),%rsi # spill
	movq %r14,%rdi
	call _insert_insn
	movl $1,-220(%rbp) # spill
	movl 8(%r12),%edi
	movl %edi,%eax
	andl $7,%eax
	cmpl $1,%eax
...
L1438:
	...
	leaq 8(%r12),%rsi
	call _move
	movl -200(%rbp),%ecx # spill
	incl %ecx
	movl %ecx,-196(%rbp) # spill
	movl -200(%rbp),%edx # spill
	movq -216(%rbp),%rsi # spill
	movq %rax,%rdi
	call _insert_insn
	movl $2,-220(%rbp) # spill
L1435:
	xorl %esi,%esi
	movl $-469694349,%edi
	call _new_insn
	movl 8(%rax),%ecx
	movq %rax,-208(%rbp) # spill
	andl $4294967288,%ecx
	orl $1,%ecx
	movq -208(%rbp),%rax # spill
	movl %ecx,8(%rax)
	movl $-2147319808,16(%rax)
	orl $1,4(%rax)
	movl -196(%rbp),%edx # spill
	movq -216(%rbp),%rsi # spill
	movq -208(%rbp),%rdi # spill
	call _insert_insn
	movl -220(%rbp),%ebx # spill
	incl %ebx
	movl %ebx,-220(%rbp) # spill
	testl $2048,4(%r12)
	jnz L1486
L1484:
	movl $2,-224(%rbp) # spill
	jmp L1487
L1488:
	movl -224(%rbp),%r13d
	shlq $5,%r13
...
L1487:
	...
	shrl $26,%eax
	addl $2,%eax
	cmpl %eax,-224(%rbp) # spill
	jb L1488
L1486:
	movl $1,-192(%rbp) # spill
	movl $2,%ecx
L1539:
	movl 4(%r12),%eax
	shll $21,%eax
...
L1541:
	...
	jmp L1539
L1547:
	movl $0,-192(%rbp) # spill
L1542:
	xorl %r13d,%r13d
	movl $2,-228(%rbp) # spill
	jmp L1551
L1552:
	movl -228(%rbp),%r15d
	shlq $5,%r15
