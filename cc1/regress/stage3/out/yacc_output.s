...
L324:
	...
	jmp L352
L356:
	cmpl %ecx,-16(%rbp) # spill
	jle L355
L353:
	movq _pos(%rip),%rax
	movswl (%rax,%rcx,2),%eax
	cmpl %eax,-44(%rbp) # spill
	movl $0,%eax
	cmovzl %eax,%r13d
	incl %ecx
L352:
